...
public record CourseClassCreatedDomainEvent(string AggregateId, string CourseClassCode, string CourseClassName, int CourseClassType,
    string SubjectCode, int SessionLength, int Session, int TotalSession, string SemesterCode, int Stage, int NumberStudentsExpected, string ParentCourseClassCode) : DomainEventBase
{
