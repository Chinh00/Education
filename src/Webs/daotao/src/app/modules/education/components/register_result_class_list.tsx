...
import {Button, Drawer, Modal, Table, Tabs, TabsProps, Tooltip, Typography} from "antd";
...
const RegisterResultClassList = ({semesterCode, subjectCode}: RegisterResultClassListProps) => {
    ...
    return (
        <>
            ...
            <Drawer width={"100%"} onCancel={() => setOpenModel(false)} open={openModel} onClose={() => setOpenModel(false)}>
